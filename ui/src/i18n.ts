...
export const messages = {
  ja: {
    ...
    local: "ローカル・読み取り専用",
    explore: "語彙を探索",
    intro: "Markdownに現れる言葉の分布とつながりを見ます。",
    reset: "全体を表示",
    search: "単語を検索",
    graph: "意味の地図",
    ...
    noWordsHelp: "設定とMarkdown本文を確認し、再解析してください。",
  ...
  en: {
    ...
    intro: "Explore the distribution and connections of words in Markdown.",
    reset: "Show all",
    search: "Search words",
    graph: "Semantic map",
    ...
    noWordsHelp:
      "Check the configuration and Markdown source, then analyze again.",
