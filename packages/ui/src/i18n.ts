...
export const messages = {
  ja: {
    ...
    search: "単語を検索",
    graph: "意味の地図",
    graphHint: "スクロール・ドラッグで移動 · Ctrl＋ホイール／ピンチで拡大縮小",
    zoomIn: "拡大",
    zoomOut: "縮小",
    showDetails: "詳細を表示",
    ...
    none: "なし",
    choose: "語を探索",
    chooseHelp: "地図の点や検索結果をクリックすると詳細を表示します。",
    connections: "語のつながり",
  ...
  en: {
    ...
    search: "Search words",
    graph: "Semantic map",
    graphHint: "Scroll or drag to pan · Ctrl + wheel or pinch to zoom",
    zoomIn: "Zoom in",
    zoomOut: "Zoom out",
    ...
    chooseHelp: "Click a map point or search result to show details.",
